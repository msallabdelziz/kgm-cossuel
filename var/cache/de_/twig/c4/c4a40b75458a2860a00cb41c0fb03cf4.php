...
class __TwigTemplate_34d80997af087be8c607dc93fcb17383 extends Template
{
    private $source;
    private $macros = [];
                ...
                <div class=\"container\">
                    ...
                    <div class=\"container\">
                            ...
                            <div class=\"row\">
                                <div class=\"col-5 mb-2\">
                                    <label class=\"fw fs-7\">Profil Utilisateur</label>
                                    <div class=\"form-control disabled bg-warning bg-opacity-25\">{{ utilisateur.type }}</div>
                                </div>
                                <div class=\"col-6 mb-2\">
                                    <label class=\"fw fs-7\">Identifiant</label>
                                    <input type=\"text\" name=\"login_u\" id=\"login_u\" class=\"form-control bg-opacity-25 fw-bold\" required=\"required\" value=\"{{ utilisateur.login }}\" />
                                </div>
                                <div class=\"col-5\">
...
{% endblock %}
", "utilisateur/edit.html.twig", "/Users/msallabdelaziz/Desktop/CossuelAppV2/kgm-cossuel-master-3/templates/utilisateur/edit.html.twig");
    }
}
