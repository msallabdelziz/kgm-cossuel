 ...
 */
class getEndroidQrCode_DomBuilderService extends App_KernelDevDebugContainer
{
    /**
     * Gets the public 'endroid_qr_code.dom_builder' shared autowired service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['endroid_qr_code.dom_builder'] = $instance = new \Endroid\QrCode\Builder\Builder();
        ...
        $instance->size(200);
        $instance->foregroundColor(new \Endroid\QrCode\Color\Color(119, 181, 254));
        $instance->margin(10);
