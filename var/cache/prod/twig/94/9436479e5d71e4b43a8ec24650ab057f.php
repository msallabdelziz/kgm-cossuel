...
class __TwigTemplate_70dd40d36dd3c01bf53877c65307b6e3 extends Template
{
    private $source;
    private $macros = [];
    ...
    <section class=\"\">
        ...
        if (twig_length_filter($this->env, ($context["les_electricien"] ?? null))) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["reg"]) {
                ...
                // line 42
                echo "                        ";
                if ((array_key_exists("electricien", $context) && (twig_get_attribute($this->env, $this->source, ($context["electricien"] ?? null), "id", [], "any", false, false, false, 42) == twig_get_attribute($this->env, $this->source, $context["reg"], "id", [], "any", false, false, false, 42)))) {
                    // line 43
                    echo "                            ";
...
";
    ...
    {
        return new Source("", "electricien/new.html.twig", "/Users/msallabdelaziz/Desktop/CossuelAppV2/kgm-cossuel-master-3/templates/electricien/new.html.twig");
    }
}
