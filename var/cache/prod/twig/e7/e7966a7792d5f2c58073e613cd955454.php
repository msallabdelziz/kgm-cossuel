...
class __TwigTemplate_ad092af97e0c7a7b65fc42e87a614f23 extends Template
{
    private $source;
    private $macros = [];
    ...
    <section class=\"\">
        ...
        echo "\"></use>
            ...
            ";
        // line 49
        if ((twig_length_filter($this->env, ($context["les_electricien"] ?? null)) == 0)) {
            // line 50
            echo "                <br />
                <div class=\"row pt-20\">
                    <div class=\"col-3\"></div>
            ...
            // line 66
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["les_electricien"] ?? null), "getTotalItemCount", [], "any", false, false, false, 66), "html", null, true);
            echo ")</caption>
            <thead>
                <tr>
            ...
            echo "            </tbody>
                ...
                ";
            // line 121
            twig_get_attribute($this->env, $this->source, ($context["les_electricien"] ?? null), "setPageRange", [0 => 1], "method", false, false, false, 121);
            // line 122
            echo "                ";
            echo $this->extensions['Knp\Bundle\PaginatorBundle\Twig\Extension\PaginationExtension']->render($this->env, ($context["les_electricien"] ?? null), "pagination.html.twig");
            echo "
