...
class __TwigTemplate_528f13c83398ed2652b7d746e79f92b6 extends Template
{
    private $source;
    private $macros = [];
    ...
    <section class=\"\">
        ...
        // line 57
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_region_show", ["id" => twig_get_attribute($this->env, $this->source, ($context["region"] ?? null), "id", [], "any", false, false, false, 57)]), "html", null, true);
        echo "\">Annuler</a>
...
";
    ...
    {
        return new Source("", "region/edit.html.twig", "/Users/msallabdelaziz/Desktop/CossuelAppV2/kgm-cossuel-master-3/templates/region/edit.html.twig");
    }
}
