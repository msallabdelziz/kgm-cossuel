...
/* rapport/edit.html.twig */
class __TwigTemplate_88d69e50d4a6ebd0bace4c0671e22ea1 extends Template
{
    private $source;
    private $macros = [];
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->loadTemplate("base.html.twig", "rapport/edit.html.twig", 1);
    ...
    <section class=\"\">
        ...
        // line 54
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_rapport_show", ["id" => twig_get_attribute($this->env, $this->source, ($context["rapport"] ?? null), "id", [], "any", false, false, false, 54)]), "html", null, true);
        echo "\">Annuler</a>
...
";
    ...
    {
        return new Source("", "rapport/edit.html.twig", "/Users/msallabdelaziz/Desktop/CossuelAppV2/kgm-cossuel-master-3/templates/rapport/edit.html.twig");
    }
}
