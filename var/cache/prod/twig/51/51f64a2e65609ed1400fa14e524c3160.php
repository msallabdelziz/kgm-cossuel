...
class __TwigTemplate_7a5604e0b3143a9402d590b46e57ae7f extends Template
{
    private $source;
    private $macros = [];
    ...
    <section class=\"\">
        ...
        if (twig_length_filter($this->env, ($context["les_proprietaire"] ?? null))) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["reg"]) {
                ...
                // line 42
                echo "                        ";
                if ((array_key_exists("proprietaire", $context) && (twig_get_attribute($this->env, $this->source, ($context["proprietaire"] ?? null), "id", [], "any", false, false, false, 42) == twig_get_attribute($this->env, $this->source, $context["reg"], "id", [], "any", false, false, false, 42)))) {
                    // line 43
                    echo "                            ";
...
";
    ...
    {
        return new Source("", "proprietaire/new.html.twig", "/Users/msallabdelaziz/Desktop/CossuelAppV2/kgm-cossuel-master-3/templates/proprietaire/new.html.twig");
    }
}
