...
/* installation/edit3.html.twig */
class __TwigTemplate_b0ffd3458c6f22a7ee7375665751d96d extends Template
{
    private $source;
    private $macros = [];
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->loadTemplate("base_modal.html.twig", "installation/edit3.html.twig", 1);
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        <header class=\"hstack pb-2 mb-2 border-bottom\">
            <a href=\"\" class=\"align-items-center text-dark text-decoration-none\">
                <span class=\"fs-4\">Modification des informations Proprietaire </span>
            </a>
        </header>
        <div class=\"row\">
        ";
                            ...
                            \t<fieldset>
                                <div class=\"card\">
                                    ...
                                    <div class=\"row\">
                                        ...
                                        ";
        // line 27
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, ($context["installationForm"] ?? null), "nom", [], "any", false, false, false, 27), 'row');
        echo "
                                        </div>
                                        <div class=\"col-lg-5\">
                                        ";
        // line 30
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, ($context["installationForm"] ?? null), "prenom", [], "any", false, false, false, 30), 'row');
        echo "
                                        </div>
                                        <div class=\"col-lg-4\">
                                            ";
        // line 33
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, ($context["installationForm"] ?? null), "numPiece", [], "any", false, false, false, 33), 'row');
        echo "
                                        </div>
                                        <div class=\"col-lg-8\">
                                            ";
        // line 36
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, ($context["installationForm"] ?? null), "adresse", [], "any", false, false, false, 36), 'row');
        echo "
                                        </div>
                                        <div class=\"col-lg-4\">
                                            ";
        // line 39
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, ($context["installationForm"] ?? null), "telephone", [], "any", false, false, false, 39), 'row');
        echo "
                                        </div>
                                        <div class=\"col-lg-4\">
                                            ";
        // line 42
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, ($context["installationForm"] ?? null), "email", [], "any", false, false, false, 42), 'row');
        echo "
                                        </div>
                                    </div>
                                </div>
...
";
    ...
    {
        return "installation/edit3.html.twig";
    }
    ...
    {
        return array (  217 => 130,  189 => 105,  143 => 61,  139 => 60,  128 => 52,  115 => 42,  109 => 39,  103 => 36,  97 => 33,  91 => 30,  85 => 27,  76 => 20,  74 => 19,  68 => 16,  60 => 11,  51 => 4,  47 => 3,  36 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "installation/edit3.html.twig", "/Users/msallabdelaziz/Desktop/CossuelAppV2/kgm-cossuel-master-3/templates/installation/edit3.html.twig");
    }
}
