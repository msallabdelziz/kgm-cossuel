...
class __TwigTemplate_85158c284c0b0d9b520cbaffc103254e065279de1ef39e69d995bef5b679b976 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        echo "\" class=\"btn btn-primary btn\">
            ...
            ";
        // line 18
        if ((twig_length_filter($this->env, (isset($context["les_agent"]) || array_key_exists("les_agent", $context) ? $context["les_agent"] : (function () { throw new RuntimeError('Variable "les_agent" does not exist.', 18, $this->source); })())) == 0)) {
            // line 19
            ...
            // line 34
            echo twig_escape_filter($this->env, twig_length_filter($this->env, (isset($context["les_agent"]) || array_key_exists("les_agent", $context) ? $context["les_agent"] : (function () { throw new RuntimeError('Variable "les_agent" does not exist.', 34, $this->source); })())), "html", null, true);
            echo ")</caption>
            <thead>
                <tr>
            ...
            $context['_seq'] = twig_ensure_traversable((isset($context["les_agent"]) || array_key_exists("les_agent", $context) ? $context["les_agent"] : (function () { throw new RuntimeError('Variable "les_agent" does not exist.', 48, $this->source); })()));
            foreach ($context['_seq'] as $context["_key"] => $context["ag"]) {
                // line 49
                echo "                    <tr>
                        <td scope=\"row\"><a href=\"";
                // line 50
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_agent_show", ["id" => twig_get_attribute($this->env, $this->source, $context["ag"], "id", [], "any", false, false, false, 50)]), "html", null, true);
                echo "\" class=\"text-dark text-decoration-none fw-bold\">";
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["ag"], "matricule", [], "any", false, false, false, 50), "html", null, true);
                echo "</a></td>
                        <td>";
                // line 51
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["ag"], "nom", [], "any", false, false, false, 51), "html", null, true);
                echo "</td>
                        <td>";
                // line 52
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["ag"], "telephone", [], "any", false, false, false, 52), "html", null, true);
                echo "</td>
                        <td>";
                // line 53
                ...
                echo "</td>
                        <td>";
                // line 54
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["ag"], "adresse", [], "any", false, false, false, 54), "html", null, true);
                echo "</td>
                        ";
                // line 56
                echo "                        ";
                ...
                echo "                        <td class=\"text-end\">
                            <a href=\"";
                // line 64
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_agent_show", ["id" => twig_get_attribute($this->env, $this->source, $context["ag"], "id", [], "any", false, false, false, 64)]), "html", null, true);
                ...
                echo "\"></use>
                            ...
                            <a href=\"";
                // line 69
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_agent_edit", ["id" => twig_get_attribute($this->env, $this->source, $context["ag"], "id", [], "any", false, false, false, 69)]), "html", null, true);
...
";
    ...
    {
        return array (  222 => 85,  217 => 82,  205 => 76,  197 => 71,  192 => 69,  186 => 66,  181 => 64,  178 => 63,  176 => 56,  172 => 54,  168 => 53,  164 => 52,  160 => 51,  154 => 50,  151 => 49,  147 => 48,  141 => 44,  139 => 43,  128 => 34,  125 => 33,  109 => 19,  107 => 18,  95 => 9,  88 => 4,  78 => 3,  59 => 2,  36 => 1,);
    }
...
{% block body %}
    <section class=\"container\">
        <div class=\"row\">
            ...
            <caption align=\"top\" class=\"fs-5 mt-0 pt-0\">Liste des agents ({{ les_agent|length }})</caption>
            <thead>
                <tr>
                    <th scope=\"col\">Matricule</th> 
                    <th scope=\"col\">Nom</th> 
...
", "agent/index.html.twig", "/Applications/MAMP/htdocs/cossuelapp2/kgm-cossuel/templates/agent/index.html.twig");
    }
}
