...
class __TwigTemplate_c468cd21ce8b7feeab180d9d3d767384 extends Template
{
    private $source;
    private $macros = [];
...
{% block body %}
    <section class=\"container\">
        <header class=\"hstack pb-2 mb-2 border-bottom\">
            ...
            <a href=\"{{ path('app_agence_create') }}\" class=\"btn btn-sm fs-7 btn-primary ms-auto\">Ajouter Agent</a>
        </header>
        <div class=\"row\">
            <div class=\"bg-body shadow bg-light\">
            <table class=\"table table-striped table-hover table-sm pt-0 mt-0\">
...
{% endblock %}
", "agent/liste.html.twig", "E:\\symfony\\kgm-cossuel-master\\templates\\agent\\liste.html.twig");
    }
}
