...
class __TwigTemplate_8049f14257a47c3aabd22db7f29e1ed5 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "paginationpop.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "paginationpop.html.twig"));
    ...
    <nav>
        ...
        <ul class=\"pagination{{ classAlign }}{{ classSize }}\">
            ...
            {% if previous is defined %}
                <li class=\"page-item\">
                    <a data-bs-toggle=\"modal\" data-bs-target=\"#modal2\" class=\"page-link\" rel=\"prev\" href=\"{{ path(route, query|merge({(pageParameterName): previous})) }}\">&laquo;&nbsp;{{ 'label_previous'|trans({}, 'KnpPaginatorBundle') }}</a>
                </li>
            {% else %}
            ...
            {% if startPage > 1 %}
                <li class=\"page-item\">
                    <a data-bs-toggle=\"modal\" data-bs-target=\"#modal2\" class=\"page-link\" href=\"{{ path(route, query|merge({(pageParameterName): 1})) }}\">1</a>
                </li>
                {% if startPage == 3 %}
                    <li class=\"page-item\">
                        <a data-bs-toggle=\"modal\" data-bs-target=\"#modal2\" class=\"page-link\" href=\"{{ path(route, query|merge({(pageParameterName): 2})) }}\">2</a>
                    </li>
                {% elseif startPage != 2 %}
                    <li class=\"page-item disabled\">
                        <span class=\"page-link\">&hellip;</span>
            ...
            {% for page in pagesInRange %}
                {% if page != current %}
                    <li class=\"page-item\">
                        <a data-bs-toggle=\"modal\" data-bs-target=\"#modal2\" class=\"page-link\" href=\"{{ path(route, query|merge({(pageParameterName): page})) }}\">{{ page }}</a>
                    </li>
                {% else %}
            ...
            {% if pageCount > endPage %}
                {% if pageCount > (endPage + 1) %}
                    ...
                    {% else %}
                        <li class=\"page-item\">
                            <a data-bs-toggle=\"modal\" data-bs-target=\"#modal2\" class=\"page-link\" href=\"{{ path(route, query|merge({(pageParameterName): (pageCount - 1)})) }}\">{{ pageCount -1 }}</a>
                        </li>
                    {% endif %}
                {% endif %}
                <li class=\"page-item\">
                    <a data-bs-toggle=\"modal\" data-bs-target=\"#modal2\" class=\"page-link\" href=\"{{ path(route, query|merge({(pageParameterName): pageCount})) }}\">{{ pageCount }}</a>
                </li>
            {% endif %}

            {% if next is defined %}
                <li class=\"page-item\">
                    <a data-bs-toggle=\"modal\" data-bs-target=\"#modal2\" class=\"page-link\" rel=\"next\" href=\"{{ path(route, query|merge({(pageParameterName): next})) }}\">{{ 'label_next'|trans({}, 'KnpPaginatorBundle') }}&nbsp;&raquo;</a>
                </li>
            {% else %}
                <li  class=\"page-item disabled\">
...
{% endif %}", "paginationpop.html.twig", "/Users/msallabdelaziz/Desktop/CossuelAppV2/kgm-cossuel-master-3/templates/paginationpop.html.twig");
    }
}
