...
class __TwigTemplate_e548e60332a0944bec1a69ec681ea8e0 extends Template
{
    private $source;
    private $macros = [];
    ...
    <section class=\"container my-3\">
        ...
        echo "
                    ...
                    <button class=\"btn btn-primary\">Envoyer email de réinitialisation</button>
                    <a href=\"";
        // line 24
...
";
    ...
    {
        return array (  129 => 25,  125 => 24,  114 => 16,  109 => 14,  102 => 9,  93 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
        ...
        <div class=\"row\">
            ...
            <div class=\"col-4 bg-warning rounded py-4\">
                ...
                <h1 class=\"h3 mb-3 font-weight-normal\">Réinitialiser le mot de passe</h1>
                    ...
                    <button class=\"btn btn-primary\">Envoyer email de réinitialisation</button>
                    <a href=\"{{ path('app_login') }}\" class=\"btn btn-secondary btn my-3\">Annuler</a>
                {{ form_end(requestForm) }}
            </div>
        </div>
    </div>
{% endblock %}
", "reset_password/request.html.twig", "/Users/msallabdelaziz/Documents/cossuel-git/kgm-cossuel-1/templates/reset_password/request.html.twig");
    }
}
