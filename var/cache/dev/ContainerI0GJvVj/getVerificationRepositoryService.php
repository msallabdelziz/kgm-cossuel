 ...
 */
class getVerificationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\VerificationRepository' shared autowired service.
     *
     * @return \App\Repository\VerificationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'VerificationRepository.php';

        return $container->privates['App\\Repository\\VerificationRepository'] = new \App\Repository\VerificationRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
