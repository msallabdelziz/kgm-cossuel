 ...
 */
class getPointNomConformeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PointNomConformeRepository' shared autowired service.
     *
     * @return \App\Repository\PointNomConformeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PointNomConformeRepository.php';

        return $container->privates['App\\Repository\\PointNomConformeRepository'] = new \App\Repository\PointNomConformeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
