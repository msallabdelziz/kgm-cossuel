 ...
 */
class getAffectationsAgentsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AffectationsAgentsRepository' shared autowired service.
     *
     * @return \App\Repository\AffectationsAgentsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AffectationsAgentsRepository.php';

        return $container->privates['App\\Repository\\AffectationsAgentsRepository'] = new \App\Repository\AffectationsAgentsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
