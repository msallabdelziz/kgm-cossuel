 ...
 */
class getInstallationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\InstallationRepository' shared autowired service.
     *
     * @return \App\Repository\InstallationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'InstallationRepository.php';

        return $container->privates['App\\Repository\\InstallationRepository'] = new \App\Repository\InstallationRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
