 ...
 */
class getReferentRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ReferentRepository' shared autowired service.
     *
     * @return \App\Repository\ReferentRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ReferentRepository.php';

        return $container->privates['App\\Repository\\ReferentRepository'] = new \App\Repository\ReferentRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
