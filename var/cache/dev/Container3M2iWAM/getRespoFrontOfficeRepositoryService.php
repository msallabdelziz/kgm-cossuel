 ...
 */
class getRespoFrontOfficeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RespoFrontOfficeRepository' shared autowired service.
     *
     * @return \App\Repository\RespoFrontOfficeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RespoFrontOfficeRepository.php';

        return $container->privates['App\\Repository\\RespoFrontOfficeRepository'] = new \App\Repository\RespoFrontOfficeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
