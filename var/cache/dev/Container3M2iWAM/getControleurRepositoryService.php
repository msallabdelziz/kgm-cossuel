 ...
 */
class getControleurRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ControleurRepository' shared autowired service.
     *
     * @return \App\Repository\ControleurRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ControleurRepository.php';

        return $container->privates['App\\Repository\\ControleurRepository'] = new \App\Repository\ControleurRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
