 ...
 */
class getDAFRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DAFRepository' shared autowired service.
     *
     * @return \App\Repository\DAFRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DAFRepository.php';

        return $container->privates['App\\Repository\\DAFRepository'] = new \App\Repository\DAFRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
