 ...
 */
class getNatureBatimentRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\NatureBatimentRepository' shared autowired service.
     *
     * @return \App\Repository\NatureBatimentRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'NatureBatimentRepository.php';

        return $container->privates['App\\Repository\\NatureBatimentRepository'] = new \App\Repository\NatureBatimentRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
