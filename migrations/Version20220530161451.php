 ...
 */
final class Version20220530161451 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE demande (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT DEFAULT NULL, installation_id INT DEFAULT NULL, dossier_id INT DEFAULT NULL, paiement_id INT DEFAULT NULL, numero VARCHAR(255) DEFAULT NULL, cout INT DEFAULT NULL, date_creation DATETIME NOT NULL, etat VARCHAR(255) NOT NULL, puissance VARCHAR(255) NOT NULL, type_demande VARCHAR(255) DEFAULT NULL, date_validation DATETIME DEFAULT NULL, numero_passage INT NOT NULL, demande_parente INT DEFAULT NULL, id_paiement INT DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', created_by VARCHAR(255) NOT NULL, updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_by VARCHAR(255) DEFAULT NULL, INDEX IDX_2694D7A5FB88E14F (utilisateur_id), INDEX IDX_2694D7A5167B88B4 (installation_id), UNIQUE INDEX UNIQ_2694D7A5611C0C56 (dossier_id), UNIQUE INDEX UNIQ_2694D7A52A4C4478 (paiement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE detail_verification (id INT AUTO_INCREMENT NOT NULL, point_verification_id INT DEFAULT NULL, visite_id INT DEFAULT NULL, conclusion TINYINT(1) DEFAULT NULL, commentaire VARCHAR(255) DEFAULT NULL, INDEX IDX_46F2AF04E1846C45 (point_verification_id), INDEX IDX_46F2AF04C1C5DC59 (visite_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE dossier (id INT AUTO_INCREMENT NOT NULL, demande_id INT NOT NULL, respo_front_office_id INT DEFAULT NULL, controleur_id INT DEFAULT NULL, referent_id INT DEFAULT NULL, num INT NOT NULL, date_creation DATETIME NOT NULL, date_affecte DATETIME DEFAULT NULL, date_cloture DATETIME DEFAULT NULL, affecte TINYINT(1) DEFAULT NULL, visite TINYINT(1) DEFAULT NULL, rapport TINYINT(1) DEFAULT NULL, attestation TINYINT(1) DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', created_by VARCHAR(255) NOT NULL, updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_by VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_3D48E03780E95E18 (demande_id), INDEX IDX_3D48E037F4CF9AD9 (respo_front_office_id), INDEX IDX_3D48E037B13E6101 (controleur_id), INDEX IDX_3D48E03735E47E35 (referent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE piece_jointe (id INT AUTO_INCREMENT NOT NULL, installation_id INT DEFAULT NULL, libelle VARCHAR(255) NOT NULL, fichier VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', created_by VARCHAR(255) NOT NULL, updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_by VARCHAR(255) DEFAULT NULL, INDEX IDX_AB5111D4167B88B4 (installation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE point_verification (id INT AUTO_INCREMENT NOT NULL, rubrique_id INT DEFAULT NULL, numero INT NOT NULL, objet_verification VARCHAR(255) NOT NULL, libelle_conclusion1 VARCHAR(255) NOT NULL, libelle_conclusion2 VARCHAR(255) NOT NULL, INDEX IDX_AC7E3C6F3BD38833 (rubrique_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE rubrique (id INT AUTO_INCREMENT NOT NULL, rapport_id INT DEFAULT NULL, numero INT NOT NULL, libelle VARCHAR(255) NOT NULL, INDEX IDX_8FA4097C1DFBCC46 (rapport_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE visite (id INT AUTO_INCREMENT NOT NULL, dossier_id INT DEFAULT NULL, rapport_id INT DEFAULT NULL, date_planifie DATETIME DEFAULT NULL, date_realise DATETIME DEFAULT NULL, date_rapporte DATETIME DEFAULT NULL, date_atteste DATETIME DEFAULT NULL, etat VARCHAR(255) DEFAULT NULL, planifie TINYINT(1) DEFAULT NULL, realise TINYINT(1) DEFAULT NULL, rapporte TINYINT(1) DEFAULT NULL, atteste TINYINT(1) DEFAULT NULL, conclusion TINYINT(1) DEFAULT NULL, commentaire VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', created_by VARCHAR(255) NOT NULL, updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_by VARCHAR(255) DEFAULT NULL, INDEX IDX_B09C8CBB611C0C56 (dossier_id), INDEX IDX_B09C8CBB1DFBCC46 (rapport_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE detail_verification ADD CONSTRAINT FK_46F2AF04E1846C45 FOREIGN KEY (point_verification_id) REFERENCES point_verification (id)');
        $this->addSql('ALTER TABLE detail_verification ADD CONSTRAINT FK_46F2AF04C1C5DC59 FOREIGN KEY (visite_id) REFERENCES visite (id)');
        ...
        $this->addSql('ALTER TABLE point_verification ADD CONSTRAINT FK_AC7E3C6F3BD38833 FOREIGN KEY (rubrique_id) REFERENCES rubrique (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE detail_verification DROP FOREIGN KEY FK_46F2AF04E1846C45');
        ...
        $this->addSql('ALTER TABLE point_verification DROP FOREIGN KEY FK_AC7E3C6F3BD38833');
        ...
        $this->addSql('ALTER TABLE detail_verification DROP FOREIGN KEY FK_46F2AF04C1C5DC59');
        ...
        $this->addSql('DROP TABLE point_verification');
