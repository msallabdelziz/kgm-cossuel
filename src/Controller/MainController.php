...
class MainController extends AbstractController
{
    ...
    public function index(Request $request, ManagerRegistry $doctrine): Response
    {
        ...
        if(in_array($role, array("ROLE_CAISSIER", "ROLE_COMPTABLE", "ROLE_DAF"))) {
            ...
            foreach ($les_demande as $demande) {
                ...
                if($usage=="domestique") { $les_stat0["Domestiques"]=$les_stat0["Domestiques"]+1; $les_stat1["Domestiques"]=$les_stat1["Domestiques"]+1; }
                if($usage=="non_domestique") { $les_stat0["Professionnelles"]=$les_stat0["Professionnelles"]+1; $les_stat1["Professionnelles"]=$les_stat1["Professionnelles"]+1;}
                if($usage=="erp_ert") { $les_stat0["ERP - ERT"]=$les_stat0["ERP - ERT"]+1; $les_stat1["ERP - ERT"]=$les_stat1["ERP - ERT"]+1;}

                if($etat=="Soumis") { $les_stat0["Soumis, en attente paiement"] = $les_stat0["Soumis, en attente paiement"]+1; $les_stat1["Soumis, en attente paiement"] = $les_stat1["Soumis, en attente paiement"]+1;}
                if($etat=="Paiement enregistré") { 
                    ...
                    if($id_auteur1) {
                        if(!isset($mes_stat["Paiement enregistré"]["user_".$id_auteur1])) {
                            ...
                            $les_stat1["Payé, en attente confirmation paiement"] = $les_stat1["Payé, en attente confirmation paiement"]+1; 
                        }
                    }
                }
                if($etat=="Paiement validé") { 
                    ...
                    if($id_auteur2) {
                        if(!isset($mes_stat["Paiement validé"]["user_".$id_auteur1])) {
                            ...
                            $les_stat1["Payé, en attente validation"] = $les_stat1["Payé, en attente validation"]+1; 
                        }
                    }
                }
                
                $les_stat0["All"] = $les_stat0["All"]+1;
                $les_stat1["All"] = $les_stat1["All"]+1;
                ...
                if($affecte == 0 and $visite == 0 and $rapport == 0 and $attestation == 0) { 
                    ...
                    if($id_auteur1) {
                        if(!isset($mes_stat["Dossier validé"]["user_".$id_auteur1])) {
                            ...
                            $les_stat1["Dossier Validé, En Attente Affectation"] = $les_stat1["Dossier Validé, En Attente Affectation"]+1; 
                        }
                ...
                if($affecte == 1 and $visite == 0 and $rapport == 0 and $attestation == 0) { 
                    ...
                    if($id_auteur1) {
                        if(!isset($mes_stat["Dossier Affecté"]["user_".$id_auteur1])) {
                            ...
                            $les_stat1["Dossier affecté"] = $les_stat1["Dossier Affecté, En Attente Visite"]+1;
                        }
                ...
                if($affecte == 1 and $visite == 1 and $rapport == 0 and $attestation == 0) { 
                    ...
                    if($id_auteur1) {
                        if(!isset($mes_stat["Visite planifiée"]["user_".$id_auteur1])) {
                            ...
                            $les_stat1["Visite Planifiée, En Attente de Rapport"] = $les_stat1["Visite Planifiée, En Attente de Rapport"]+1; 
                        }
                ...
                if($affecte == 1 and $visite == 1 and $rapport == 1 and $attestation == 0) { 
                    ...
                    if($id_auteur1) {
                        if(!isset($mes_stat["Rapport élaboré"]["user_".$id_auteur1])) {
                            ...
                            $les_stat1["Visite Réalisée, En Attente de validation Rapport"] = $les_stat1["Visite Réalisée, En Attente de validation Rapport"]+1; 
                ...
                if($affecte == 1 and $visite == 1 and $rapport == 1 and $attestation == 1) { 
                    ...
                    if($id_auteur1) {
                        if(!isset($mes_stat["Rapport validé"]["user_".$id_auteur1])) {
                            ...
                            $les_stat1["Rapport validé, en attente clôture"] = $les_stat1["Rapport validé, en attente Cloture"]+1;
                ...
                if($usage=="domestique") { 
                    ...
                    if($id_auteur1) {
                        if(!isset($mes_stat["Demande Domestique"]["user_".$id_auteur1])) {
                            ...
                            $les_stat1["Domestiques"]=$les_stat1["Domestiques"]+1;
                        }
                    }
                }
                if($usage=="non_domestique") { 
                    ...
                    if($id_auteur1) {
                        if(!isset($mes_stat["Demande Professionnelle"]["user_".$id_auteur1])) {
                            ...
                            $les_stat1["Professionnelles"]=$les_stat1["Professionnelles"]+1;
                        }
                    }
                }
                if($usage=="erp_ert") { 
                    ...
                    if($id_auteur1) {
                        if(!isset($mes_stat["Demande ERP - ERT"]["user_".$id_auteur1])) {
                            ...
                            $les_stat1["ERP - ERT"]=$les_stat1["ERP - ERT"]+1;
                        }
                    }
                }
                ...
                if($etat=="Soumis") { 
                    ...
                    if($id_auteur1) {
                        if(!isset($mes_stat["Demande Soumise"]["user_".$id_auteur1])) {
                            ...
                            $les_stat1["Soumis, en attente paiement"] = $les_stat1["Soumis, en attente paiement"]+1; 
                ...
                if($usage=="domestique") { 
                    ...
                    if($id_auteur1) {
                        if(!isset($mes_stat["Demande Domestique"]["user_".$id_auteur1])) {
                            ...
                            $mes_stat["Demande Domestique"]["user_".$id_auteur1]++;
                            $les_stat2["Domestiques"]=$les_stat2["Domestiques"]+1;
                        }
                    }
                }
                if($usage=="non_domestique") { 
                    ...
                    if($id_auteur1) {
                        if(!isset($mes_stat["Demande Professionnelle"]["user_".$id_auteur1])) {
                            ...
                            $mes_stat["Demande Professionnelle"]["user_".$id_auteur1]++;
                            $les_stat2["Professionnelles"]=$les_stat2["Professionnelles"]+1;
                        }
                    }
                }
                if($usage=="erp_ert") { 
                    ...
                    if($id_auteur1) {
                        if(!isset($mes_stat["Demande ERP - ERT"]["user_".$id_auteur1])) {
                            ...
                            $mes_stat["Demande ERP - ERT"]["user_".$id_auteur1]++;
                            $les_stat2["ERP - ERT"]=$les_stat2["ERP - ERT"]+1;
                        }
                    }
                }
                ...
                if($etat=="Soumis") { 
                    ...
                    if($id_auteur1) {
                        if(!isset($mes_stat["Demande Soumise"]["user_".$id_auteur1])) {
                            ...
                            $mes_stat["Demande Soumise"]["user_".$id_auteur1]++;
                            $les_stat2["Soumis, en attente paiement"] = $les_stat2["Soumis, en attente paiement"]+1;
                        }
                    }
                }
    ...
    #[Route('/demandeUser/{restr}', name: 'main_demandeUser', methods: ['GET', 'POST'])]
    public function demandeUser(String $restr, Request $request, ManagerRegistry $doctrine): Response
    {
        $val_filtre = array(); $page = 0; $orderBy = "";
        $em = $doctrine->getManager(); $tools = new Tools($em);
        $userConn = $em->getRepository(Utilisateur::class)->find($this->getUser()->getId());
        ...
        $id=$userConn->getId();
        $demande = $em->getRepository(Demande::class)->findByRestr3($val_filtre, $orderBy, $page,$id);
        //$demande= $les_demande->findBy(["created_by"=>$userConn->getId()]);
        // usually you'll want to make sure the user is authenticated first
        $this->denyAccessUnlessGranted('IS_AUTHENTICATED_FULLY');
        return $this->render('main/demandeUser.html.twig', [
            'les_demande' => $demande,
            'titre'=> $restr,
