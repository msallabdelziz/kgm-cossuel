...
class AgentController extends AbstractController
{
    ...
    #[Route('/add', name: 'add')]
    public function create(Request $request,NotifMail $mailer,NotifierInterface $notifier, ManagerRegistry $doctrine, AgenceRepository $agenceRepository, AgentRepository $agentRepository, SluggerInterface $slugger, AffectationsAgentsRepository $agaffRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $ag="Bienvenue à Cossuel.";
            $mailer->notification($email,$ag);

           // $notification = new Notification(
             //   'Hello World!',
               // ['sms/twilio'], // Le prefix chat/ fait référence aux chatter_transports dans le fichier notifier.yaml
            //);
