...
#[ORM\Entity(repositoryClass: ElectricienRepository::class)]
class Electricien
{
    use createdAtTrait;
    ...
    #[ORM\ManyToOne(targetEntity: Localite::class, inversedBy: 'electricien')]
    private $localite;

    #[ORM\OneToMany(mappedBy: 'electricien', targetEntity: Installation::class)]
    private $installation;

    #[ORM\Column(length: 255)]
    private ?string $autreNumTelephone = null;
    ...
    public function addInstallation(Installation $installation): self
    {
        if (!$this->installation->contains($installation)) {
            ...
            $installation->setElectricien($this);
        }
    ...
    public function removeInstallation(Installation $installation): self
    {
        if ($this->installation->removeElement($installation)) {
            ...
            if ($installation->getElectricien() === $this) {
                $installation->setElectricien(null);
            }
        }
    ...
    {
        return $this->autreNumTelephone;
    }

    public function setAutreNumTelephone(string $autreNumTelephone): self
    {
        $this->autreNumTelephone = $autreNumTelephone;
